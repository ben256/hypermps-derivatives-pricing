...
def train(
    ...
    train_file, val_file, _ = find_dataset(dataset_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder-type', type=str, choices=['shared', 'split'], default='shared')
    parser.add_argument('--dataset-dir', type=str, default='../data/datasets/TT_d2_corr0-3')
